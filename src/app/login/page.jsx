                ...
                <div className="card bg-base-100 sm:shadow-2xl">
                    <div className="card-body">
                        <form onSubmit={onSubmit}>
                            <h1 className='text-4xl font-bold text-center mb-5 text-red-500'>Login</h1>
                            ...
                            <fieldset className="fieldset w-87.5">
                                ...
                                <Button className="btn  mt-4 w-full bg-red-500 text-lg font-semibold py-7 sm:py-3" type='submit'>Login</Button>
                                <p> Don’t have an account? <Link className=' font-bold underline text-red-500' href={'/register'}>Register</Link></p>
                            </fieldset>
                        </form>
                    </div>
                </div>
